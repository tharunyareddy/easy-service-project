...
public interface IContractorService {
	...
	List<Maintenance> getMaintenanceByContractName(String contractName) throws ContractNotFoundException;
	
	List<Maintenance> getMaintenanceByContractorName(String contractorName) throws ContractNotFoundException;
